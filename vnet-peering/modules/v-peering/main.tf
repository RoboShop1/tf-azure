...
resource "azurerm_virtual_network_peering" "example-2" {
  ...
  remote_virtual_network_id = "/subscriptions/12f9be95-f674-4dc3-8c29-d915cc4e1f8e/resourceGroups/iteration-1/providers/Microsoft.Network/virtualNetworks/dev-network"
}